...
class MyUser(models.Model):
    ...
    location = models.CharField(_('user address'), max_length=100)
...
class Order(models.Model):
    ...
    '''
    # MyUser 의 location 정보를 참조하려 하였으나 참조 무결성 제약조건에 어긋남
    ...
    '''
    location = models.CharField(_('destination'), max_length=100, default='')
