    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('myuser', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='orders', to='api.MyUser', verbose_name='유저')),
            ],
            options={
                'verbose_name': '주문',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('title', models.CharField(default='', max_length=100, verbose_name='글제목')),
                ('image', models.ImageField(blank=True, upload_to='', verbose_name='글사진')),
                ('content', models.TextField(default='', verbose_name='글내용')),
                ('pub_date', models.DateTimeField(default=django.utils.timezone.now, verbose_name='작성일자')),
                ('myuser', models.ForeignKey(default=1, on_delete=django.db.models.deletion.CASCADE, related_name='reviews', to='api.MyUser', verbose_name='유저')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('manufacturer', models.ForeignKey(max_length=50, on_delete=django.db.models.deletion.CASCADE, related_name='products', to='api.Manufacturer', verbose_name='제조업체')),
            ],
            options={
                'verbose_name': '상품',
        ...
        migrations.AddField(
            model_name='order',
            name='product',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='orders', to='api.Product', verbose_name='상품'),
        ),
        migrations.AddField(
            model_name='myuser',
            name='product',
